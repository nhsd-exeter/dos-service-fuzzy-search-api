...
POSTCODE_MAPPING_SERVICE_URL := https://uec-dos-api-pca-sgg-uec-dos-api-pc-ingress.$(TEXAS_HOSTED_ZONE)/api
POSTCODE_MAPPING_USER := fuzzy-search-api@nhs.net
POSTCODE_MAPPING_PASSWORD := $$(make secret-fetch NAME=uec-dos-api-sfsa-sg-cognito-passwords | jq .POSTCODE_PASSWORD | tr -d '"' )
