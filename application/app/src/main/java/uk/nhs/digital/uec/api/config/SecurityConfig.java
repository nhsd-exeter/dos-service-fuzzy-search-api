...
import static uk.nhs.digital.uec.api.util.Constants.FUZZY_SEARCH_URL;
import static uk.nhs.digital.uec.api.util.Constants.HEALTH_CHECK_LIVENESS_URL;
import static uk.nhs.digital.uec.api.util.Constants.HEALTH_CHECK_READINESS_URL;
import static uk.nhs.digital.uec.api.util.Constants.WELCOME_URL;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    List<String> permitAllEndpointList = Arrays.asList(HEALTH_CHECK_READINESS_URL,HEALTH_CHECK_LIVENESS_URL,WELCOME_URL,FUZZY_SEARCH_URL);
