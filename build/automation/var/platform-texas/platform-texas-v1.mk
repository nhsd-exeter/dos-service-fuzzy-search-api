...
AWS_ECR_NON_PROD = $(or $(AWS_ACCOUNT_ID_NONPROD), 000000000000).dkr.ecr.$(AWS_DEFAULT_REGION).amazonaws.com
AWS_REGION = eu-west-2
AWS_DEFAULT_REGION = $(AWS_REGION)
AWS_ALTERNATIVE_REGION = eu-west-1
AWS_ROLE_PIPELINE = uec-sf-jenkins-assume-role
AWS_ROLE_SESSION = uec-sf-jenkins-mom
