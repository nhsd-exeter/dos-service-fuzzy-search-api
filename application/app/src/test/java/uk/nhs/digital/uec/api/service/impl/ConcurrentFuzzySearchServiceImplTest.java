...
class ConcurrentFuzzySearchServiceImplTest {
  ...
  @InjectMocks
  private ConcurrentFuzzySearchServiceImpl fuzzySearchService;
  ...
  @Test
  @DisplayName("Assert that when fuzzySearch method when invoked, will combine list of DosServices and work accordingly even when list from the sources are empty")
  void fuzzySearch() throws ExecutionException, InterruptedException, InvalidParameterException, NotFoundException {
